...
public class QuanLySach {
    ...
    static int nhaplc() throws IOException {
        ...
        else if(a.equalsIgnoreCase("tapchi")) return 2;
        else if(a.equalsIgnoreCase("bao")) return 3;
        else return 0;
    }
    ...
    static void timtl(Sach sa, TapChi tc, Bao bao, int lc) throws IOException {
        switch(lc){
            case 1:
                if(sa!=null) hienthisach(sa);
                break;
            case 2:
                if(tc!=null) hienthitc(tc);
                break;
            case 3:
                if(bao!=null) hienthibao(bao);
                break;
            default:
                System.out.println();
        }
